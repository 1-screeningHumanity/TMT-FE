  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <button className="bg-[#7d00d0] text-white text-sm font-semibold rounded-lg w-80 h-10 mx-auto block my-6 mt-20">
          로그아웃
        </button>
      </AlertDialogTrigger>
      <AlertDialogContent className="w-5/6">
        ...
        <AlertDialogFooter className="flex flex-row gap-4 items-center justify-center">
          <AlertDialogAction className="w-20" onClick={signOutButton}>
            네
          </AlertDialogAction>
