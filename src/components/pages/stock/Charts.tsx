...
export default function Charts() {
  ...
  const downBorderColor = '#0505a8'

  // Each item: 시가，close，lowest，highest
  ...
  const volumes = [
    ...
    91950000, 248680000, 99380000, 85130000, 89440000, 75560000, 82270000,
    71870000, 78750000, 71260000, 69690000, 90540000, 101690000, 93740000,
    94130000, 91950000, 248680000, 99380000, 85130000, 89440000, 102600000,
    104890000, 85230000, 115230000, 99410000, 90120000, 79990000, 107100000,
    81020000, 91710000, 84510000, 118160000,
  ]
  ...
  return (
    <div>
      <div className="mt-5  w-full h-96 text-white">
