  ...
  return(
    <>
      <div className="flex mx-10 justify-between my-10 items-center">
        <div className="rounded-full bg-[#f6f7f9] flex justify-center items-center w-4 h-4" onClick={()=> history.back()}>
        ...
        <div className="rounded-full bg-[#f6f7f9] flex justify-center items-center w-5 h-5" onClick={()=> location.href="/mypage"}>
