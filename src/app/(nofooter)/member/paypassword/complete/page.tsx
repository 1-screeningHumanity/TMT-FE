...
export default function complete (){
  return(
    <section>
      ...
      <button className="bg-[#7d12ff] text-white text-md font-semibold rounded-lg w-80 h-10 mx-auto block my-20 font-[Pretendard-Regular]" onClick={()=> location.href="/member/signin"} >
        로그인
      </button>
    </section>
  )
