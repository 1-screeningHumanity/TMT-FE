...
export default function signin(){
  ...
  return(
    <section className="w-full mx-auto px-10">
      ...
      <Link href={"/member/signup"} className="border-[1px] w-full h-10 mx-auto my-6 block rounded-lg text-[#7d00d0] border-[#7d00d0] font-extrabold text-sm text-center leading-10">계정만들기</Link>
