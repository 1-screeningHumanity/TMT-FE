...
export default async function reservationTradeLists(){
  ...
  return (
    <section>
      <div className="w-80 bg-[#7d12ff] text-white h-10 mx-auto flex items-center justify-center rounded-md mt-5">예약 내역</div>
      <div className="flex gap-2 text-md overflow-x-scroll text-center mt-5 border-b-2 py-2 font-[Pretendard-Regular] pl-4 w-full">
      ...
      { reservationTradeLists.length == 0 ? <div className="text-center mt-5">예약 내역이 없습니다.</div> :
